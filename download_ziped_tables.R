...
clean_up_data <- function(the_year) {
  ...
  if(!dir.exists(paste0(datadir, the_year))) {
    dir.create(path=paste0(datadir, the_year))
  } 
...
#lapply(years, clean_up_data) ## This was here to move files that hadn't been correctly placed in their 'year' dirs. It should be necessary anymore